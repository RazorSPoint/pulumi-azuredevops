...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"azuredevops_serviceendpoint_permissions":    {Tok: makeResource("Security", "ServiceEndpointPermissions")},
			...
			"azuredevops_project_permissions":            {Tok: makeResource("Security", "ProjectPermissions")},
			"azuredevops_git_permissions":                {Tok: makeResource("Security", "GitPermissions")},
			"azuredevops_resource_authorization":         {Tok: makeResource("Security", "ResourceAuthorization")},
			"azuredevops_area_permissions":               {Tok: makeResource("Security", "AreaPermissions")},
			"azuredevops_iteration_permissions":          {Tok: makeResource("Security", "IterationPermissions")},
		},
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"azuredevops_area":             {Tok: makeDataSource("Classifications", "getArea")},
			"azuredevops_iteration":        {Tok: makeDataSource("Classifications", "getIteration")},
		},
