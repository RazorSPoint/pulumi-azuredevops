...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"azuredevops_group_membership":            {Tok: makeResource("Graph", "GroupMembership")},
			"azuredevops_agent_pool":                  {Tok: makeResource("Agent", "Pool")},
			"azuredevops_group":                       {Tok: makeResource("Graph", "Group")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			"azuredevops_projects":         {Tok: makeDataSource("Core", "getProject")},
			"azuredevops_group":            {Tok: makeDataSource("Graph", "getGroup")},
			"azuredevops_git_repositories": {Tok: makeDataSource("Repository", "getRepositories")},
			"azuredevops_users":            {Tok: makeDataSource("Graph", "getUsers")},
		},
